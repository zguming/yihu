...
import com.botian.yihu.activity.WrongAnswerActivity;
 ...
 */
//直播
public class WrongAnswerFragment extends RxFragment {
    ...
    public void initView() {
        final WrongAnswerActivity activity = (WrongAnswerActivity) getActivity();
    ...
    public static WrongAnswerFragment newInstance(WrongData content, int i, int total) {
    ...
    public void updateWrongDataBase() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                WrongData noteData = new WrongData();
                noteData.setType(2);
                noteData.updateAll("topicId=? and cl=? ", topicId + "", cl + "");
            }
        }).start();
    }
}
