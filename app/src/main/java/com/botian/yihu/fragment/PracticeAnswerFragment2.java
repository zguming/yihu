 ...
 */
//直播
public class PracticeAnswerFragment2 extends RxFragment {
    ...
    PracticeAnswerActivity activity;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        activity = (PracticeAnswerActivity) getActivity();
    ...
    public static PracticeAnswerFragment2 newInstance(PracticeAnswer.DataBean content, int i, int total) {
        ...
        PracticeAnswerFragment2 fragment = new PracticeAnswerFragment2();
