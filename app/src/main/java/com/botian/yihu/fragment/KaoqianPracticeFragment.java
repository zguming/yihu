 ...
 */
//直播
public class KaoqianPracticeFragment extends RxFragment {
    Unbinder unbinder;
    ...
    public void initView() {
        final KaoQianActivity activity = (KaoQianActivity) getActivity();
    ...
    public static KaoqianPracticeFragment newInstance(KaoQianNormal.DataBean content, int i, int total) {
        ...
        KaoqianPracticeFragment fragment = new KaoqianPracticeFragment();
