 ...
 */
//直播
public class PracticeAnswerFragment extends RxFragment {
    ...
    public void initView() {
        final PracticeAnswerActivity activity = (PracticeAnswerActivity) getActivity();
    ...
    public static PracticeAnswerFragment newInstance(PracticeAnswer.DataBean content, int i, int total) {
