 ...
 */
//直播
public class MoniPracticeFragment extends RxFragment {
    Unbinder unbinder;
    ...
    public void initView() {
        final SimulationTestActivity2 activity = (SimulationTestActivity2) getActivity();
    ...
    public static MoniPracticeFragment newInstance(MoniTopic.DataBean content, int i, int total) {
        ...
        MoniPracticeFragment fragment = new MoniPracticeFragment();
