 ...
 */
//直播
public class WrongAnswerFragment2 extends RxFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        activity = (WrongAnswerActivity) getActivity();
    ...
    public static WrongAnswerFragment2 newInstance(WrongData content, int i, int total) {
        ...
        WrongAnswerFragment2 fragment = new WrongAnswerFragment2();
