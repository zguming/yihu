 ...
 */
public class ChapterPracticeSpecialAdapter extends RecyclerView.Adapter<ChapterPracticeSpecialAdapter.MyViewHolder> {
    ...
    public ChapterPracticeSpecialAdapter(Context mContext, List<ChapterPracticeOneBean.DataBean> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chapter_practice_special, parent, false);
