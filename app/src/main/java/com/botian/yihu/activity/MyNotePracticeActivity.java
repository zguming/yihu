...
import com.botian.yihu.fragment.NoteAnswerFragment;
import com.botian.yihu.fragment.NoteAnswerFragment2;
...
public class MyNotePracticeActivity extends RxAppCompatActivity {
    ...
    private List<NoteData> practiceList = new ArrayList<>();
    //背题数据
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Observable.create(new ObservableOnSubscribe<Integer>() {
            ...
            public void subscribe(ObservableEmitter<Integer> emitter) throws Exception {
                practiceList = DataSupport.order("id desc").find(NoteData.class);
                //String a=Thread.currentThread().getName();
                for (int i = 0; i < practiceList.size(); i++) {
                    Fragment fragment2 = NoteAnswerFragment2.newInstance(practiceList.get(i), i, practiceList.size());
                    Fragment fragment = NoteAnswerFragment.newInstance(practiceList.get(i), i, practiceList.size());
            ...
            public void onPageScrollStateChanged(int state) {
                Observable.create(new ObservableOnSubscribe<Integer>() {
                    ...
                    public void subscribe(ObservableEmitter<Integer> emitter) throws Exception {
                        ...
                        .observeOn(AndroidSchedulers.mainThread())
                        .compose(MyNotePracticeActivity.this.<Integer>bindToLifecycle())
                        .subscribe(new Observer<Integer>() {
                            @Override
                            public void onSubscribe(Disposable d) {
                                //Log.d(TAG, "subscribe");
    ...
    public void Event(TopicCardEventNote messageEvent) {
        if (answer666 == 0) {
