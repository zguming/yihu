...
public class RegisterContranct {
    ...
    public interface RegisterModel {
        ...
        void model(CallBack callBack,Context context,String phone);
        void model(CallBack callBack,Context context,String phone,String mobilelz,String pwd);
    ...
    public interface RegisterPresenter {
        void presenter(Context context, String phone);
        void presenter(Context context, String phone,String mobilelz,String pwd);
    }
